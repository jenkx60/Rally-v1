...
export default function AuthLanding() {
  ...
  const handleContinue = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Navigate to sign up or login based on email check
    }, 1000)
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2 text-center">
        <h1 className="text-4xl font-bold text-foreground">Welcome to Rally</h1>
        <p className="text-lg text-muted-foreground">Turn group chats into real plans</p>
      </div>
      ...
      <form onSubmit={handleContinue} className="space-y-6">
        ...
        <button
          type="button"
          className="w-full py-3 px-4 rounded-lg border border-border bg-background hover:bg-muted transition-colors flex items-center justify-center gap-3 font-medium text-foreground"
        >
          <svg
            className="w-5 h-5"
            viewBox="0 0 24 24"
